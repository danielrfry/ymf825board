...
+ After successfully loading, each file will appear on the tab. If you do verify and write as it is, Arduino will work.
+ ymf825board_sample2.ino is a program that automatically plays 1 octave in semitone units.
...
## Module Interface
| IF Function | details | When it's called | include |
|---|---|---|---|
...
## Module Interface
| IF Function | 処理内容 | コールするタイミング | include |
|---|---|---|---|
